...
|---|---|---|---|---|
| P3-1 | 라우트 등록 + SilverLayout | `step-1-routes.md` | `figures/step-1-*.png` | ⬜ 미착수 |
| P3-2 | 컴포넌트 + API 연동 | `step-2-components.md` | `figures/step-2-*.png` | ⬜ 미착수 |
| P3-3 | SignalDetailPage | `step-3-signals.md` | `figures/step-3-*.png` | ⬜ 미착수 |
